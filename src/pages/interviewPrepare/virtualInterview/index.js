  ...
  return (
    <S.Wrap>
      ...
      <S.InterviewQuestionBlock>
        ...
        <S.ButtonContainer>
          <Button text={"질문 수정하기"} width={"192px"} height={"44px"} backgroundColor={"#FFFFFF"} color={"#333335"} onClick={() => navigate("/prepare/question-list")}  />
          <Button text={"다음으로"} width={"192px"} height={"44px"} backgroundColor={"#333335"} color={"#F1F4F9"} onClick={() => navigate("/summary/content-summary")} />
        </S.ButtonContainer>
      </S.InterviewQuestionBlock>
    </S.Wrap>
  );
